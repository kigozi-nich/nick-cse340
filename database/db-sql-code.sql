...
CREATE TYPE public.account_type AS ENUM
    ('first-name', 'second-name', 'third-name', 'Client', 'Employee', 'Admin');

ALTER TYPE public.account_type
    OWNER TO cse_340_5pot_user;
...
-- Create relationship beteen 'classification' and 'inventory'tables
ALTER TABLE public.inventory
    ADD CONSTRAINT classification_fk FOREIGN KEY (classification_id)
